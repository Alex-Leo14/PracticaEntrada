...
namespace EDOSwit.AbstraccionSP
{
        ...
        where T : class, new()
    {
        ...
        public static SqlConnection GetConnection2(int iTipoConexion)
        {
            string connexion = ConfigurationManager.ConnectionStrings["MBConnectionString"].ConnectionString.ToString();
            SqlConnection conn = new SqlConnection(connexion);
            return conn;
        }

        public static SqlConnection GetConnection1(int iTipoConexion)
        {
            string connexion = ConfigurationManager.ConnectionStrings["MBConnection"].ConnectionString.ToString();
            SqlConnection conn = new SqlConnection(connexion);
            return conn;
        }
        ...
        {
            return ConfigurationManager.ConnectionStrings["MBConnection"].ConnectionString.ToString();
        }
