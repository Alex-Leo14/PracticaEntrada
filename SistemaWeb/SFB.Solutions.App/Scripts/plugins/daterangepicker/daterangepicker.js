    ...
    DateRangePicker.prototype = {
        ...
        setOptions: function(options, callback) {
            ...
            this.ranges = {
                ...
                'Despues 7 Dias': [moment().subtract(6, 'days'), moment()],
                'Despues 30 Dias': [moment().subtract(29, 'days'), moment()],
        ...
        renderCalendar: function (calendar, selected, minDate, maxDate, side) {
            ...
            if (!minDate || minDate.isBefore(calendar.firstDay)) {
                html += '<th class="prev available"><i class="fa fa-arrow-circle-left icon icon-arrow-left fa fa-arrow-circle-left"></i></th>';
            } else {
                html += '<th></th>';
            }
            ...
            if (!maxDate || maxDate.isAfter(calendar.lastDay)) {
                html += '<th class="next available"><i class="fa fa-arrow-circle-right icon icon-arrow-right fa fa-arrow-circle-right"></i></th>';
            } else {
                html += '<th></th>';
            }
